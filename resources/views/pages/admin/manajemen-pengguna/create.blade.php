...
<div class="flex items-center gap-3 text-sm font-semibold mb-5">
        ...
        <p class="text-sm font-bold text-default-900">Input Data Manajemen Pengguna</p>
    </div>
      ...
      <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
        ...
        <div class="grid lg:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div style="position: relative; width: 100%;">
              <input type="password" name="password_confirmation" id="passwordConfirmInput" class="form-input" required
                style="padding-right: 40px;">
