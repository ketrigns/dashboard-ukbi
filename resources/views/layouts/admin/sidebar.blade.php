    ...
    : '' }}" href="{{ route('hasil-data-mining.index') }}">
            ...
            : '' }}" href="{{ route('users.index') }}">
                    ...
                    @if(auth()->check() && auth()->user()->role === 'admin')
                        <div class="menu-item" style="list-style: none; margin: 0; padding: 0;">
                            <a class="group flex items-center gap-x-3.5 rounded-md px-3 py-2 text-sm font-medium text-default-400 transition-all hover:bg-default-100/5 {{ request()->routeIs('admin.approvals.*')
                ? 'active'
